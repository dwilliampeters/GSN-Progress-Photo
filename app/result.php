    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="text-center">
          <img src="test.jpg" class="img-thumbnail img-responsive" />
        </div>
        ...
        <div class="row">
          <div class="col-xs-12">
            <p class="text-center"><a href="/gsnchallenge/" class="btn btn-success"><i class="glyphicon glyphicon-chevron-left"></i> Start over</a></p>
          </div>
        </div>
